...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 27, 2023 at 04:08 AM
...
INSERT INTO `borrowing_op` (`borrowing_id`, `product_id`, `member_id`, `borrowing_date`, `borrowing_return_date`) VALUES
(45, 118, 26, '2023-03-27', '2023-04-11');
...
(118, '', 'Et est corporis mol', '23', 'Repudiandae ab adipi', 'Ipsa alias minim en', 79, './images/product-7.jpg', 'Vente', 'books', '0000-00-00', '0000-00-00', 'Borrowed'),
...
(194, '', 'Payback in Death: An Eve Dallas Novel', 'J.D. Robb', 'English', '\r\nLt. Eve Dallas is just home from a long overdue vacation when she responds to a call of an unattended death. The victim is Martin Greenleaf, retired Internal Affairs Captain. At first glance, the sc', 368, './images/51Y7iA+8bML._SY346_.jpg', 'Location', 'magazines', '2023-03-24', '0000-00-00', '0'),
...
INSERT INTO `reservation_op` (`reservation_id`, `product_id`, `member_id`, `reservation_date`, `reservation_expiry_date`) VALUES
(65, 119, 26, '2023-03-27', '2023-03-28'),
(66, 189, 26, '2023-03-27', '2023-03-28');
...
--
ALTER TABLE `borrowing_op`
  MODIFY `borrowing_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
