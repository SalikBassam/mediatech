...
<div class="kk">
    ...
    <section id="section2" class="section2">
      <div id="searchparent">
        <div>
        <ul>
   <a href="iindex.php?product_type=All"> <li>All</li></a>
    <a href="iindex.php?product_type=Books"><li>Books</li></a>
    <a href="iindex.php?product_type=Novels"><li>Novels</li></a>
    <a href="iindex.php?product_type=Magazines"><li>Magazines</li></a>
    <a href="iindex.php?product_type=Cassettes"><li>Cassettes</li></a>
   <a href="iindex.php?product_type=CDs"> <li>CDs</li></a>
    <a href="iindex.php?product_type=DVD"><li>DVD</li></a>
  </ul>
</div>
<form method="get" action="iindex.php">
