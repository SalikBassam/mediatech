...
if (isset($_POST['reserve'])) {
  ...
  $sql = "SELECT COUNT(*) as num_borrowed FROM borrowing_op WHERE  borrowing_status='on' AND member_id = :member_id";
  $stmt = $pdo->prepare($sql);
  ...
  $sql = "SELECT COUNT(*) as num_reservations FROM reservation_op WHERE reservation_status='on' AND member_id = :member_id";
  $stmt = $pdo->prepare($sql);
  $stmt->bindValue(':member_id', $_SESSION['member_id']);
  $stmt->execute();
...
$sql = "SELECT * FROM reservation_op WHERE reservation_status='on' AND product_id = :product_id";
$stmt = $pdo->prepare($sql);
$stmt->bindValue(':product_id', $product_id);
$stmt->execute();
