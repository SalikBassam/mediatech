  ...
  if($stmt->execute()){
    ...
    if($member && password_verify($password, $member['member_password'])) {
      ...
      if($member['member_admin'] == "yes") {
        ...
        exit();
      } else if($member['member_penalties'] >= 3) {
        $error_message = '<span style="color: red;">Sorry, you are banned from logging in.</span>';
      } else {
...
<body>
<img src="./images/log.jpg" alt="bg" class="bg">
...
<form action="" method="post" id="signupForm">
  <div class="signup-block" style="display: none;">
    ...
    <?php endif; ?>
    <br>
    <button type="submit" onclick="validateSignup()"  name="signup_submit">Submit</button>
  </div>
</form>
