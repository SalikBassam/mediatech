...
if(isset($_POST['delete'])){
    ...
    // Prepare the SQL query to delete the product with the specified ID
...
<!-- end boostrap -->
    ...
    <!-- css file -->
    <link rel="stylesheet" href="adminMData.css" />
    ...
    <!-- add item modal -->
                ...
                <div class=" d-flex flex-column gap-3">
                  ...
                  <div class="d-flex gap-3">
                    ...
                    <div class="w-50 formvalid">
                      ...
                      <input type="number" min="0" name="product_author" class="form-control" id="product_author" placeholder="Joan Smith" />
                      <small></small>
                    </div>
                  </div>
                  <div class="d-flex gap-3">
      ...
      <div class="modal modal-lg fade" id="updateproduct" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content h-25">
            <div class="modal-body container p-5">
              <form action="adminMData.php" method="POST" id="myFormadd" enctype="multipart/form-data">
                ...
                <div class=" d-flex flex-column gap-3">
                  ...
                  <div class="d-flex gap-2 flex-wrap m-3 ">
                    ...
                    <div class="rectangle">
                      <input id="image-input" name="images" type="file" class="form-control">
                    </div>
                  </div>
                  <small></small>
                  </div>
                  <div class="d-flex gap-3">
                    <div class="w-50 formvalid">
                      <label for="titleAdd" class="form-label">Title</label>
                      <input type="text" name="product_title" class="form-control" id="titleAdd" placeholder="Title" />                      <small></small>
                    </div>
                    <div class="w-50 formvalid">
                      <label for="priceAdd" class="form-label">Author's Name</label>
                      <input type="number" min="0" name="priceAdd" class="form-control" id="priceAdd" placeholder="Joan Smith" />
                      <small></small>
                    </div>
                  </div>
                  <div class="d-flex gap-3">
                  ...
                  <div class="justify-content-end d-flex">
                    <!-- <button value="addBtn" type="submit" class="btn bg-dark text-white" id="addBtn">Ajouter</button> -->
                  </div>
                </div>
              </form>
            </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Are you sure you will delete this product?</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <p>Name of product: <span id="product-name"></span></p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">No</button>
        <button type="submit" name="delete" class="btn btn-danger" onclick="deleteProduct()">Yes</button>
...
?>
  ...
  <div><img src="<?= $item['product_cover_image']; ?>" alt="product"></div>
    <div>
      ...
      <div class="icons">
        <img src="./images/trash-solid.svg" data-bs-toggle="modal" data-bs-target="#exampleModal">
...
<script src="adminMdata.js"></script>
